#
# Manifiesto del módulo 'Show-LogsLogin'
#
# Generado por Estrella D. & Fernanda R.
#
# Generado el 14/09/2024
#

@{

# Módulo de script o archivo de módulo binario asociado con este manifiesto.
RootModule = 'Show-LogsLogin.psm1'
...
GUID = '9b77868d-fa3e-43b1-8e71-ae0ba44b1e30'

# Autor de este módulo.
Author = 'Estrella D. & Fernanda R.'
...
Copyright = '(c) 2024 Estrella D. & Fernanda R.. Todos los derechos reservados.'

# Descripción de la funcionalidad proporcionada por este módulo.
Description = 'The script lists the logins depending on the number of sessions given by the user. The admin permissions are required in order to get results.'
